...
def main():
    ...
    #create variable to follow which table has won
    hasThisTableWon = [0] * 100
    ...
    for numberIndex, number in enumerate(numberList):
        ...
        for tableIndex, table in enumerate(bingoBoardList):
            if hasThisTableWon[tableIndex] != 1:
                print("")
                print("")
                ...
                print("The actual inspected table is:",bingoBoardList[tableIndex])
                print("The actual inspected table is:",bingoResultList[tableIndex])
                print("Tableindex is {}".format(tableIndex))
                for colRow in range(0,5):
                    if ( (bingoResultList[tableIndex][colRow][0] == 1 and
                        ...
                        print("This is a winner table! The number is: {}".format(tableIndex)) 
                        print("Removing the winner table index...")
                        hasThisTableWon[tableIndex] = 1
                        
                        print("The winner number that was just called is: {}".format(number))
                        if hasThisTableWon.count(0) == 0:
                            ...
                            print("The number of the last table is: {}".format(tableIndex))
                            print("The sum is: {}".format(sum))
                            print("The solution is: {}".format( sum*int(number) ))
                            return
                        break
